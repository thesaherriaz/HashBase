...
export default function LoginSimple() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Admin login hardcoded for reliability
    if (username === "adbms" && password === "adbms") {
      ...
      // Navigate to home by reloading the page
      setTimeout(() => {
    ...
    // For demo purposes, show error for non-admin users
    toast({
      title: "Login failed",
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="text-center text-sm text-muted-foreground mt-4">
                <p>Default admin credentials: adbms / adbms</p>
              </div>
            </form>
          </CardContent>
        </Card>
